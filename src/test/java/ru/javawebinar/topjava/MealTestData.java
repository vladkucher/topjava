...
public class MealTestData {
    ...
    public static final ModelMatcher<MealWithExceed> MATCHER2 = ModelMatcher.of(MealWithExceed.class);
    ...
    public static final List<MealWithExceed> MEALS_WITH_EXCEED_BETWEEN = Arrays.asList(
            new MealWithExceed(100007, of(2015, Month.MAY, 31, 20, 0),"Ужин", 510,true),
            new MealWithExceed(100006, of(2015, Month.MAY, 31, 13, 0),"Обед", 1000,true));
